...
<template>
  <SectionLayout v-if="profile">
    <div class="flex flex-row space-x-3 lg:space-x-7">
      <NuxtImg :src="image" :alt="name" class="rounded-sm" placeholder quality="100" sizes="100 md:150 lg:250px"
        fit="contain" />
      <div class="flex flex-col space-y-2 col-span-2">
        ...
        <ProfileResume v-if="profile.resume" :file="profile.resume" />
      </div>
    </div>
