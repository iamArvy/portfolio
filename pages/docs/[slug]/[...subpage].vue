...
breadcrumbs.value = ["docs", slug, ...subpage];
</script>
          ...
          <ul class="flex flex-col gap-2 p-2 overflow-x-auto flex-1">
            <li v-for="item in page?.body?.toc?.links" :key="item.id">
              <NuxtLink
                ...
                :class="[
                  'text-sm hover:text-primary transition-all ease-in-out duration-200',
